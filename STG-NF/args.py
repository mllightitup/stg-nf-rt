...
def init_sub_args(args):
    ...
    if (
        ...
        args.vid_path = {"train": args.vid_path_train, "test": args.vid_path_test}

        args.pose_path = {"train": args.pose_path_train, "test": args.pose_path_test}
    else:
        args.vid_path = {
...
def init_parser(default_data_dir="data/", default_exp_dir="data/exp_dir"):
    ...
    parser.add_argument(
        "--only_test", action="store_true", help="Visualize train/test data"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Train and Eval on Specific Clip",
    )
    parser.add_argument(
        "--global_pose_segs", action="store_false", help="Use unormalized pose segs"
    )
    ...
    parser.add_argument(
        "--batch_size", type=int, default=256, metavar="B", help="Batch size for train"
    )
    parser.add_argument(
        "--epochs",
        "-model_e",
    ...
    parser.add_argument(
        "--model_hidden_dim", type=int, default=0, help="Features dim dimension"
    )
    ...
    parser.add_argument("--R", type=float, default=3.0, help="Features dim dimension")
    parser.add_argument(
        "--temporal_kernel",
        type=int,
        default=None,
        help="Odd integer, temporal conv size",
    )
    parser.add_argument(
        "--edge_importance", action="store_true", help="Adjacency matrix edge weights"
    )
    parser.add_argument(
        "--flow_permutation", type=str, default="permute", help="Permutation layer type"
    )
    parser.add_argument(
        "--adj_strategy", type=str, default="uniform", help="Adjacency matrix strategy"
    )
    parser.add_argument(
        "--max_hops", type=int, default=8, help="Adjacency matrix neighbours"
    )
